        ...
        <div class="container-fluid text-center">
            ...
            <div class="row">
              <div class="col-lg-8 mb-4 noticia">
                <h2>Duro camino de Colo-Colo de Camino a la Copa Libertadores</h2>
              ...
              <div class="col-lg-8 mb-4">
                <img src="../src/img/colo-colo.jpg" class="img-fluid">
              </div>
            </div>
            <div class="row">
                <div class="col-lg-4 mb-4">
                  <img src="../src/img/oconnor.png" class="img-fluid">
                </div>
                <div class="col-lg-4 mb-4 noticia">
                    <h2>Ben O'Connor desata el caos en la Vuelta a España</h2> 
              ...
              <div class="row">
                <div class="col-lg-4 mb-4 noticia">
                    <h2>GP de Países Bajos de F1: horarios y dónde ver los entrenamientos libres 3</h2>
                ...
                <div class="col-lg-4 mb-4">
                  <img src="../src/img/F1.png" class="img-fluid">
                </div>
              </div>
          </div>    
    </main>
