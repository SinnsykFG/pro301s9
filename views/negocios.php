        ...
        <div class="container-fluid text-center">
            ...
            <div class="row">
              <div class="col noticia">
                <h2>5 sectores laborales que tendrán una elevada demanda en el futuro (y las habilidades necesarias para tener éxito en ellos)</h2>
              ...
              <div class="col noticia">
                <h2>Por qué hay temor a una recesión en EE.UU. y qué consecuencias está teniendo en los mercados del mundo</h2> 
              ...
              <div class="col noticia">
                <h2>Para qué sirve el anillo inteligente desarrollado por Samsung que cuesta más de US$400</h2>
            ...
            <div class="row">
                <div class="col"><img class="img-fluid" src="../src/img/negocio1.png" alt="fururo laboral"></div>
                <div class="col"><img class="img-fluid" src="../src/img/negocio2.png" alt="Recesion"></div>
                <div class="col"><img class="img-fluid" src="../src/img/negocio3.jpg" alt="Anillo Samsung"></div>
