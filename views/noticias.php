...
<main>
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-lg-8 mb-4 noticia">
                <h2>Caso Audio: exfiscales coinciden en que es probable que Hermosilla quede en prisión preventiva</h2>
                <img src="../src/img/hermosilla.jpg" alt="Hermosilla" class="img-fluid">
        ...
        <div class="col-lg-4 mb-4 noticia">
            <h2>Tricel destituye a gobernadora de Región de Coquimbo por notable abandono de deberes</h2>
            <img src="../src/img/kris-naranjo.png" alt="Naranjo" class="img-fluid">
            <p>
  ...
  <div class="row ">
    <div class="col-lg-4 mb-4 text-center noticia">
                <h2>Récord de audiencia en la última noche de la Convención Demócrata en Chicago | Noticias Telemundo</h2>
